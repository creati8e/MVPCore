...
import mvp_core.cache.ComponentCache;
...
public class PresenterHelper<PRESENTER extends MvpPresenter> {
    ...
    public <V extends MvpView & ComponentHolder> PresenterHelper(V viewHolder, @Nullable Bundle bundle) {
        view = viewHolder;
        holder = viewHolder;
    ...
    private Object findCachedComponent(@Nullable Bundle bundle) {
